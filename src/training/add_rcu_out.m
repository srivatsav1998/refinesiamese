function [out, rcu_count] = add_rcu_out(net, rcu_count, prev_layer_name, base_name, ip)
    base_name = sprintf([base_name '_outrcu%d'], rcu_count);
    relu_count = 1;
    conv_count = 1;
    sum_count = 1;
    bnorm_count = 1;
    ...
    [sum_out, ~] = add_sum(net, sum_count, inps, conv_out.dimensions, base_name);
