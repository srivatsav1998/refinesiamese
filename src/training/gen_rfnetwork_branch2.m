function output = gen_rfnetwork_branch2(net)
    ...
    % ip1.dim = [61 61 96];
    base_name = 'branch2';
    inputs{1}.name = 'br2_x4';
    inputs{1}.fmaps = 96;
    inputs{1}.dimensions = [61 61 96];

    inputs{2}.name = 'br2_x8';
    inputs{2}.fmaps = 256;
    inputs{2}.dimensions = [55 55 256];

    inputs{3}.name = 'br2_x11';
    inputs{3}.fmaps = 384;
    inputs{3}.dimensions = [53 53 384];

    inputs{4}.name = 'br2_x14';
    inputs{4}.fmaps = 384;
    inputs{4}.dimensions = [51 51 384];

    inputs{5}.name = 'br2_out';
    inputs{5}.fmaps = 32;
    inputs{5}.dimensions = [49 49 32];
